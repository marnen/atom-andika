...
export function activate() {
  ...
  // disposables.add(
  //   atom.config.onDidChange('andika.fontFamily', applyFont),
  //   atom.config.onDidChange('andika.secondaryFonts', applyFont),
  // )
  //
...
//     `:root { --andika-package-editorfont: ${font}; }`,
//     {
//       sourcePath: 'andika-package-editorfont'
//     },
//   )
//
//   triggerMeasurements()
